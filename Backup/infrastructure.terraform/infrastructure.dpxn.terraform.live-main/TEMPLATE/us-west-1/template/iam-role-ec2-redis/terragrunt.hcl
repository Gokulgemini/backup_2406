...
inputs = {
  policy_name = "redis-${local.env}-${local.app_environment}-policy"
  policy_description = "Used for the Redis Server (${local.app_environment})"
...
EOF
  role_name = "redis-${local.env}-${local.app_environment}-role"
