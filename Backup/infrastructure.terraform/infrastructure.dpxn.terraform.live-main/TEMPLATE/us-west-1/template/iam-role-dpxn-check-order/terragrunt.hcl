...
inputs = {
  ...
  policy_statement        = templatefile("policy/statements.tftpl", {
                      ...
                      sqs-dpxn-print-scan-ingestion-queue-arn = dependency.sqs-dpxn-print-scan-ingestion.outputs.queue_arn
                      s3-dpxn-check-order-bucket-arn = dependency.s3-dpxn-check-order.outputs.s3_bucket_arn,
                      s3-dpxn-print-scan-ingestion-bucket-arn = dependency.s3-dpxn-print-scan-ingestion.outputs.s3_bucket_arn,
  ...
  oidc_fully_qualified_subjects   = [
    "system:serviceaccount:print-scan-service-layer:dlx-check-order"
  ]
