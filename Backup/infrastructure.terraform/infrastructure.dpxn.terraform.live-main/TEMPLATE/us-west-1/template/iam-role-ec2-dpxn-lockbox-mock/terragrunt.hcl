...
inputs = {
  ...
  create_policy           = true
  role_name               = "dpxn-${local.env}-${local.app_environment}-lockbox-mock"
  role_description        = "Role used by dpxn lockbox mock service (${local.app_environment})"
  policy_name             = "${local.env}-${local.app_environment}-lockbox-mock-policy"
  policy_description      = "Used for the Lockbox Mock service (${local.app_environment})"
