locals {
  ...
  queue_name = "${local.infra_environment}-${local.app_environment}-pay-router-responder-events"
  ...
  policy                      = [
                                {
                                  ...
                                  condition = [{
                                    ...
                                    values = [dependency.sns-dpxn-payment-router-responder-events.outputs.sns_topic_arn]
                                  }]
                                }]
}
