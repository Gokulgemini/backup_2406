...
dependency "iam-role-ec2-redis" {
  config_path = "${get_terragrunt_dir()}/../iam-role-ec2-redis"
...
inputs = {
  ...
  iam_instance_profile = dependency.iam-role-ec2-redis.outputs.aws_iam_instance_profile_arn
  ...
  security_groups = [ dependency.vpc-info.outputs.baseline_sg_id, dependency.vpc-info.outputs.db_sg_id ]
  vpc_zone_identifier = dependency.vpc-info.outputs.db_prim_subnet_ids
