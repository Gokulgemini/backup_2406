...
inputs = {
  users = [{
      ...
      user_name = "pen_admin"
      pen_sftp_id = dependency.transfer-sftp-dpxn-acknowledgement.outputs.pen_sftp_id
      pen_transfer_server_role_arn = dependency.transfer-sftp-dpxn-acknowledgement.outputs.pen_sftp_transfer_server_iam_role
