...
dependency "iam-role-ec2-dpxn-ack-worker" {
  config_path = "${get_terragrunt_dir()}/../iam-role-ec2-dpxn-ack-worker"
...
inputs = {
  ...
  iam_instance_profile = dependency.iam-role-ec2-dpxn-ack-worker.outputs.aws_iam_instance_profile_arn
