locals {
  ...
  queue_name        = "${local.infra_environment}-${local.app_environment}-file-events-aim"
...
inputs = {
  ...
  max_receive_count           = 1
  kms_master_key_id           = dependency.kms-dpxn-aim-backgroundservices.outputs.kms_arn
  ...
  policy                      = [
                                {
                                  ...
                                  condition = [{
                                    ...
                                    values = [dependency.sns-dpxn-file-events.outputs.sns_topic_arn]
                                  }]
                                }]
}
