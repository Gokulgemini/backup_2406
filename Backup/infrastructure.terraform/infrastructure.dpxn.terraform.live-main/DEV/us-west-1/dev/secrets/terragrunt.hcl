...
terraform {
  source = "git::ssh://git@bitbucket.deluxe.com:7999/dtf/aws-secretsmanager-seed.git//?ref=${local.modules_version}"
}
...
inputs = {
  ...
  secret_prefix = "${local.app_environment}/${local.app_name}/"
