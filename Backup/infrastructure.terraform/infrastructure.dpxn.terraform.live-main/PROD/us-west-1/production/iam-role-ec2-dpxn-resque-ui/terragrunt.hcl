...
inputs = {
  policy_name             = "${local.env}-${local.app_environment}-resque-ui-policy"
  policy_description      = "Used for the Resque-ui-(${local.app_environment})"
...
EOF
  role_name               = "${local.env}-${local.app_environment}-resque_ui-role"
