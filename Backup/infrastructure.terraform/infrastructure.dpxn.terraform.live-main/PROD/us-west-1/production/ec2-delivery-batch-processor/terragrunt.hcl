...
dependency "iam-role-ec2-dpxn-delivery-batch-processor" {
  config_path = "${get_terragrunt_dir()}/../iam-role-ec2-dpxn-delivery-batch-processor"
...
inputs = {
  ...
  iam_instance_profile = dependency.iam-role-ec2-dpxn-delivery-batch-processor.outputs.aws_iam_instance_profile_arn
  instance_key_name = dependency.key-pair-app.outputs.key_pair_key_name
  min_size = 1
  max_size = 1
  default_cooldown = 300
  desired_capacity = 1
  app_name = "delivery-batch-processor"
  run_list = "role[dpxn_delivery_batch_processor]"
  ...
  asg_tags = flatten([ dependency.common-tags.outputs.asg_common_tags, [
  {
    ...
    "key" = "ServerRole"
    "value" = "delivery_batch_processor"
    "propagate_at_launch" = true
  },{
    "key" = "PamReady"
    "value" = "false"
