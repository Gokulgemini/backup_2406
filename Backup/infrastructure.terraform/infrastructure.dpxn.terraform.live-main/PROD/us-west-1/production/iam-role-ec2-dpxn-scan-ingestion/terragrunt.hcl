...
dependency "sqs-dpxn-scan-ingestion" {
  config_path = "${get_terragrunt_dir()}/../sqs-dpxn-scan-ingestion"
  ...
  "Statement": [
    {
      ...
      "Effect": "Allow",
      "Resource": "${dependency.sqs-dpxn-scan-ingestion.outputs.queue_arn}"
    },
    {
      "Action": [
        "sqs:DeleteMessage",
    ...
    },
    {
      ...
      "Resource": [
        ...
        "${dependency.kms-sqs-scan-ingestion.outputs.kms_arn}",
        "${dependency.kms-sqs-check-print.outputs.kms_arn}"
      ]
    },
    {
