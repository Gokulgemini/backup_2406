...
inputs = {
  protocol = "sqs"
  sns_topic_arn = dependency.sns-dpxn-payment-router-responder-events.outputs.sns_topic_arn
  target_endpoint_arn = [dependency.sqs-dpxn-payment-router-responder-events.outputs.queue_arn]
}
