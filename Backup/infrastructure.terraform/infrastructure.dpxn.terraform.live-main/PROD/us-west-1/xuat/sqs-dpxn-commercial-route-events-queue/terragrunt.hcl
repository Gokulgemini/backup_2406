locals {
  ...
  queue_name = "${local.infra_environment}-${local.app_environment}-cml-route-events-queue"
  ...
  policy                      = [
                                {
                                  ...
                                  condition = [{
                                    ...
                                    values = [dependency.sns-dpxn-commercial-route-topic.outputs.sns_topic_arn]
                                  }]
                                }]
}
