...
terraform {
  source = "git::git@github.com:verifyvalid/infrastructure.dpx_fulfillment.terraform.modules.git//ses-ruleset?ref=${local.modules_version}"
}
...
inputs = {
  rule_set_name = "dpxn-${local.infra_env}-${local.app_environment}-inbound"
}
