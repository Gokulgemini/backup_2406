...
namespace RDM.Messaging.ImageVault.Tests
{
    ...
    public class ReplyAddImageMessageUnitTests
    {
        [Fact]
        [Trait("Category", "Unit")]
        public void ReplyAddImageMessage_Serialize_ToString()
        {
            // Arrange
        ...
        public void ReplyAddImageMessage_Deserialize_FromString()
        {
            ...
            // Act
            var result = JsonConvert.DeserializeObject<ReplyAddImageMessage>(json);
        ...
        {
            // Act
            var exception = Record.Exception(() => new ReplyAddImageMessage(AddImageStatus.Success, null));
        ...
        {
            // Act
            var item = Activator.CreateInstance<ReplyAddImageMessage>();

            // Assert
            Assert.Equal(ReplyAddImageMessage.RabbitExchange, item.ExchangeName);
            Assert.Equal(ReplyAddImageMessage.RabbitQueue, item.DefaultQueueName);
            Assert.Equal(ReplyAddImageMessage.RabbitKey, item.RoutingKey);
        }
        ...
        public void Ctor_ValidParameters_ObjectCreated()
        {
            ...
            // Act
            var item = new ReplyAddImageMessage(AddImageStatus.Success, imageId);
        ...
        private ReplyAddImageMessage CreateTestMessage(bool variant = false)
        {
            return new ReplyAddImageMessage(AddImageStatus.Success, variant ? new ImageId("77fbc7618e5c47a2a181ae5a9a74a01e") : new ImageId("97c921f0ecfc411b9997bd6720ceb26b"));
        }
    }
}
