...
namespace RDM.Messaging.ImageVault.Tests
{
    ...
    public class ReplyGetImageByIrnMessageUnitTests
    {
        [Fact]
        [Trait("Category", "Unit")]
        public void ReplyGetImageByIrnMessage_Serialize_ToString()
        {
            // Arrange
        ...
        [Fact]
        [Trait("Category", "Unit")]
        public void ReplyGetImageByIrnMessage_Deserialize_FromString()
        {
            // Arrange
            var item = CreateTestMessage();
            ...
            // Act
            var result = JsonConvert.DeserializeObject<ReplyGetImageByIrnMessage>(json);
        ...
        {
            // Act
            var exception = Record.Exception(() => new ReplyGetImageByIrnMessage(GetImageStatus.Success, null));
        ...
        {
            // Act
            var item = Activator.CreateInstance<ReplyGetImageByIrnMessage>();

            // Assert
            Assert.Equal(ReplyGetImageByIrnMessage.RabbitExchange, item.ExchangeName);
            Assert.Equal(ReplyGetImageByIrnMessage.RabbitQueue, item.DefaultQueueName);
            Assert.Equal(ReplyGetImageByIrnMessage.RabbitKey, item.RoutingKey);
        }
        ...
        private ReplyGetImageByIrnMessage CreateTestMessage(bool variant = false)
        {
            var image = CreateTestImage(variant);
            return new ReplyGetImageByIrnMessage(GetImageStatus.Success, image);
        }
    }
}
