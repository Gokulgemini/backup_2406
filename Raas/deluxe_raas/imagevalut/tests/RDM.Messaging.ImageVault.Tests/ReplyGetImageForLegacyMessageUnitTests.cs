...
namespace RDM.Messaging.ImageVault.Tests
{
    ...
    public class ReplyGetImageForLegacyMessageUnitTests
    {
        [Fact]
        [Trait("Category", "Unit")]
        public void ReplyGetImageForLegacyMessage_Serialize_ToString()
        {
            // Arrange
        ...
        [Fact]
        [Trait("Category", "Unit")]
        public void ReplyGetImageForLegacyMessage_Deserialize_FromString()
        {
            // Arrange
            var item = CreateTestMessage();
            ...
            // Act
            var result = JsonConvert.DeserializeObject<ReplyGetImageForLegacyMessage>(json);
        ...
        {
            // Act
            var exception = Record.Exception(() => new ReplyGetImageForLegacyMessage(GetImageStatus.Success, null));
        ...
        {
            // Act
            var item = Activator.CreateInstance<ReplyGetImageForLegacyMessage>();

            // Assert
            Assert.Equal(ReplyGetImageForLegacyMessage.RabbitExchange, item.ExchangeName);
            Assert.Equal(ReplyGetImageForLegacyMessage.RabbitQueue, item.DefaultQueueName);
            Assert.Equal(ReplyGetImageForLegacyMessage.RabbitKey, item.RoutingKey);
        }
        ...
        private ReplyGetImageForLegacyMessage CreateTestMessage(bool variant = false)
        {
            var image = CreateTestImage(variant);
            return new ReplyGetImageForLegacyMessage(GetImageStatus.Success, image);
        }
    }
}
